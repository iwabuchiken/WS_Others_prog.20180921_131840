...
python -m pip install virtualenv
        ...
        C:\WORKS_2\WS\WS_Others\prog\D-34\5_>python -m pip install virtualenv
...
python -m virtualenv env
        ...
        New python executable in C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\env\Scripts\py
        thon.exe
...
pip list
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL>pip list
...
python -m pip install django==1.10
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL>python -m pip install django==1.1
        0
...
python manage.py runserver
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\django_project>python manage.py r
        unserver
...
python manage.py migrate > migrate.log
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\django_project>Operations to perform:
...
pip install sympy
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\django_project>pip install sympy
        Collecting sympy
...
pip install numpy
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\django_project>pip install numpy
...
pip install matplotlib
        ...
        (env) C:\WORKS_2\WS\WS_Others\prog\D-34\5_\VIRTUAL\django_project>pip install matplotlib
